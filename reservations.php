                        ...
                        <div class="main-container">
                            ...
                            <form class="returning-client-form" id="returningForm" method="post" action="javascript:void(0)">
                                <div class="form-section" style="display:none;">
                                    ...
                                    <input type="hidden" name="recipientemail" value="reservations@park9dogs.com">
                                ...
                                <div class="form-section">
                                    ...
                                    <span style="display:block;margin-bottom:10px;font-size:12px;color:#ff6600;padding-left:27px;">(You will be required at confirmation to fill out forms)</span>
                                ...
                                <div class="form-section">
                                    ...
                                    <input type="text" name="Pet_Name" placeholder="ex. Fido, Spot, Rover">
                                </div>
                                <div class="form-section">
                                    <label for="Pet_Breed">Breed(s)</label>
                                    <input type="text" name="Pet_Breed" placeholder="ex. Labrador, Siamese">
                                </div>
                                <div class="form-section">
                                    <label for="Pet_Age">Age(s)</label>
                                    <input type="text" name="Pet_Age" placeholder="" style="width:100px;">
                                </div>
                                <div class="form-section">
                                ...
                                <div class="form-section">
                                    ...
                                    <select id="Services_Required" name="Services_Required">
                                        ...
                                        <option value="Dog_Boarding" class="playcare-request">Dog Boarding (includes all day Playcare)</span></option>
                                        <option value="Playcare" class="playcare-request">Playcare Only</option>
                                        <option value="Cat_Boarding" class="cat-option">Cat Boarding</span></option>
                                    </select>
                                </div>
