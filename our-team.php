                ...
                <div class="content">
                    <div class="main-wrapper our-promise">
                        <div class="main-container">
                            ...
                            <p><i class="fa fa-circle bullet-point"></i>We use all natural, biodegradable products wherever possible throughout the facility. We use chemical free high pressure to steam clean and disinfect. The use of solar tubes throughout the playground and pool allows us to conserve electricity (AND it’s great for the dogs!). We sell and use as many locally sourced, recycled and environmentally friendly products we can find. We will continually strive to lessen our environmental impact.</p>
                    ...
                    <div class="social-section quote">
                        ...
                        <h3 style="text-align:right;font-weight:400;color:#ff6600;">- Louis Sabin</h3>
                    </div>
                </div>
                <div class="clear"></div>
            </div>
