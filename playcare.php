    		...
    		<div class="content-wrapper" id="main">
                ...
                <div class="content">
                    <div class="main-wrapper service-playcare">
                        <div class="main-container">
                            ...
                            <p>There are times when you just can’t make it to the park AND that big meeting at work.<br>
                                For those times, and more, we provide crate free playcare that’s full of high quality, safe, and enriching play equipment and toys. Lots of 2 legged supervision and interaction from our experienced team and plenty of friendly 4 legged playmates means your best friend will surely have the best day ever.</p>

                            <p>Our indoor playground is large and full of natural light so every dog has the space to play and run around, or just curl up for a nap away from the fun.</p>

                            <p>There’s a large outdoor playground that offers a splashpark, lots of room to run, chase or just hang out.<br>
                            ...
                            <p><i class="fa fa-circle bullet-point"></i> Webcams to watch while you're at work</p>
                            ...
                            <p>Up to 3 hours of play - <span class="orange">$24</span><br>
                                Up to 6 hours of play - <span class="orange">$36</span><br>
                                Up to 13 hours of play - <span class="orange">$42</span></p>
                    ...
                    <div class="social-section quote">
                        ...
                        <h3 style="text-align:right;font-weight:400;color:#ff6600;">- Gilda Radner</h3>
                    </div>
                </div>
                <div class="clear"></div>
            </div>
