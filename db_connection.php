...
define("SITE_URL_REMOTE", "http://" . $_SERVER['HTTP_HOST'] . "/");
...
if ($isLocal == true) {
    ...
    define('DB_SERVER', '172.16.13.7'); // eg, localhost - should not be empty for productive servers
    define('DB_SERVER_USERNAME', 'park9_usr');
    define('DB_SERVER_PASSWORD', 'GQ9VRqqHjBVyzALi');
    define('DB_DATABASE', 'park9_db');
    $conn = mysqli_connect(DB_SERVER, DB_SERVER_USERNAME, DB_SERVER_PASSWORD, DB_DATABASE) or die("Error " . mysqli_error($conn));
}
